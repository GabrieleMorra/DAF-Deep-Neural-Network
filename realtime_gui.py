...
class RealTimeTableGUI:
    ...
    def setup_gui(self):
        ...
        self.tree = ttk.Treeview(table_container, columns=columns, show='headings', 
                                height=18, style="Modern.Treeview", selectmode='extended')
        ...
        control_frame = tk.Frame(self.root, bg=self.colors['dark'], height=60)
        ...
        self.add_config_button = self.create_control_button(
            button_frame, "+ Add Models", self.open_add_config_window, self.colors['secondary'], "left", font_size=12
        )
        
        self.export_button = self.create_control_button(
            button_frame, "↓ Export", self.export_table, self.colors['accent'], "left", font_size=12
        )
    ...
    def collect_training_data(self, data_queue):
        ...
        while True:
            try:
                ...
                # Handle other exceptions with logging
    ...
    def add_new_configurations(self, new_configs):
        ...
        # Add only unique configurations
